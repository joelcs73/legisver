...
Route::resource('diputadoscomisiones','DiputadosComisionesController');
Route::get('diputadoscomisiones/c/{idComision}','DiputadosComisionesController@comisiones');
Route::get('diputadoscomisiones/d/{idDiputado}','DiputadosComisionesController@diputados');
Route::get('diputadoscomisiones/c/{idComision}/{legislatura}','DiputadosComisionesController@comisioneslegislatura');
Route::get('diputadoscomisiones/d/{idDiputado}/{legislatura}','DiputadosComisionesController@diputadoslegislatura');
